...
class _$InvalidCredentials implements InvalidCredentials {
  ...
  @override
  String toString() {
    return 'WeatherFailure.invalidCredential(message: $message)';
  }
...
abstract class InvalidCredentials implements WeatherFailure {
...
class _$NetworkFailure implements NetworkFailure {
  ...
  @override
  String toString() {
    return 'WeatherFailure.networkFailure(message: $message)';
  }
...
abstract class NetworkFailure implements WeatherFailure {
